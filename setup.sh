...
docker-compose exec --user root php-fpm wp core install \
    --url=localhost \
    --title="PBrocks Testing" \
    --admin_user="pbrocks" \
    --admin_email="pbrocks@test.ing" \
    --admin_password="pbassword" \
    --allow-root
...
docker-compose exec --user root php-fpm wp theme delete twentyseventeen --allow-root
docker-compose exec --user root php-fpm wp theme delete twentynineteen --allow-root
docker-compose exec --user root php-fpm wp theme delete twentytwenty --allow-root
